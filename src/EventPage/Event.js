...
const Event = () => {
    ...
    const { books,featured} = useContext(BookContext);
    console.log(books)
...
console.log(books)
  return (
    <Container>
      ...
      <Title style={{fontWeight: 'bold' ,textAlign: 'center'}}> Christmas Collections</Title>

      <ContainerForProduct>
      
      {books
             .filter(book=>book.category===Category&&book.featured===true &&book.quantity!==0)
             .map(({ image: image, id, title }) => (
